...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        while True:
            ...
            if faceNum > 0:
                if faceNum > 1:
                    cv2.putText(frame, "Warning: The number of faces is more than 1", (10, 100),
                ...
                for i in range(faceNum):
                    ...
                    try:
                        ...
                        if best_class_probabilities > 0.87:
                            ...
                            message = "FACE_RECOGNITION_CONFIRM"
                            FrameCountThr = threading.Thread(target=FrameCount, args=[
                                                             Frames, serverName, message])
                            FrameCountThr.start()
                        else:
                            fancyDraw(frame, bbox)
                            Frames.append({
            ...
            cv2.putText(frame, "Fps: {:.2f}".format(
                fps), (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 1)
